...
public class Enemy : MonoBehaviour
{
    ...
    private SlimeHealth slimeHealth; // Tham chiếu script máu mới

    void Awake()
    {
        animator = GetComponent<Animator>();
        rb = GetComponent<Rigidbody2D>();
        slimeHealth = GetComponent<SlimeHealth>(); // Lấy component máu
    }
    ...
    void Update()
    {
        ...
        if (slimeHealth != null && !slimeHealth.IsAlive()) return;
